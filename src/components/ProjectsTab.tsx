...
const styles = StyleSheet.create({
  ...
  sgBox: { backgroundColor: LUCY_COLORS.primaryMist, borderWidth: 1, borderColor: LUCY_COLORS.primaryLine, borderRadius: 16, padding: 12, marginBottom: 14 },
  ...
  moveBox: { backgroundColor: LUCY_COLORS.primarySoft, borderWidth: 1, borderColor: LUCY_COLORS.primaryLine, borderRadius: 16, padding: 14, marginBottom: 14 },
