...
When the user says phrases like "I'll come back to this", "need to check later", "still pending", "remind me about this", "I don't know if X happened", or leaves something clearly unresolved, extract it as an open_loop with a brief description of what is unresolved. When the user says "I asked X to do Y", "X is handling this", "waiting on X for Y", extract it as a follow_up with the person as assignee and the pending action.`;
